...
def plot_train_result(real_image, gen_image, recon_image, epoch, save=False,  show=True, fig_size=(19, 9.5)):
    ...
    for ax, img in zip(axes.flatten(), imgs):
        ax.axis('off')
        #ax.set_adjustable('box-forced') - Scale to 0-255
        img = img.squeeze()
    ...
    fig.text(0.5, 0.4, title, ha='center')
